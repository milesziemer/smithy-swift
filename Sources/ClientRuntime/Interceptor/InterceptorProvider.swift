...
public protocol InterceptorProvider {
    ...
    func create<RequestType: RequestMessage, ResponseType: ResponseMessage, AttributesType: HasAttributes>()
        -> any Interceptor<RequestType, ResponseType, AttributesType>
}
